...
const tableData: Device[] = [
    {
        ...
        ip: "192.168.0.21",
        status: "Connected",
        image: "/images/devices/product-01.jpg", // Replace with actual image URL
    },
    {
        id: "2",
        ...
        ip: "192.168.0.22",
        status: "Disconnected",
        image: "/images/devices/product-02.jpg",
    },
    {
        id: "3",
        ...
        ip: "192.168.0.23",
        status: "Connected",
        image: "/images/devices/product-03.jpg", 
    },
    {
        id: "4",
        ...
        ip: "192.168.0.25",
        status: "Disconnected",
        image: "/images/devices/product-04.jpg",
    },
    {
        id: "5",
        ...
        ip: "192.168.0.27",
        status: "Connected",
        image: "/images/devices/product-05.jpg",
    },
];
                ...
                <Table>
                    ...
                    <TableBody className="divide-y divide-gray-100 dark:divide-gray-800">
                        ...
                        {tableData.map((device) => (
                            ...
                            <TableRow key={device.id} className="">
                                ...
                                <TableCell className="py-3">
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="h-[50px] w-[50px] overflow-hidden rounded-md">
                                            <img src={device.image} className="h-[50px] w-[50px]" alt={device.name}/>
                                        </div>
                                ...
                                <TableCell className="py-3 text-gray-500 text-theme-sm dark:text-gray-400">
                                    ...
                                    <Badge size="sm" color={device.status === "Connected" ? "success" : "error"}>
                                        {device.status}
                                    </Badge>
