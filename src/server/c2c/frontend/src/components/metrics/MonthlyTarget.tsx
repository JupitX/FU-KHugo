    ...
    const options: ApexOptions = {
        ...
        plotOptions: {
            radialBar: {
                ...
                track: {
                    background: Palette.light.beige,
                    strokeWidth: "100%",
                    margin: 5
                },
                dataLabels: {
